...
def test(db, split, testiter,
         ...
         debugEnc=False, debugDec=False, check_dir_path='', args=None):
    # result_dir = system_configs.result_dir
    # result_dir = os.path.join(result_dir, str(testiter), split)
    result_dir = './experiment/{}/test/{}'.format(args.exp, testiter)
    ...
    cache_file = check_dir_path + '/LSTR_{}.plk'.format(test_iter)
...
if __name__ == "__main__":
    ...
    check_dir_path = 'experiment/' + args.exp + '/save' + "/checkpoints"
    # print("system config...")
