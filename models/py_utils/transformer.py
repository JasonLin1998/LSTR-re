...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, query_embed, pos_embed):
        ...
        query_embed = query_embed.unsqueeze(1).repeat(1, bs, 1) # 7 16 32
...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1,
                 activation="relu", normalize_before=False):
        super().__init__()
        self.self_attn = nn.MultiheadAttention(d_model, nhead, dropout=dropout) # 32 2 0.1
    ...
    def forward_post(self,
        ...
        # src [240,16,32] pos[240,16,32]
        src2, weights = self.self_attn(q, k, value=src, attn_mask=src_mask,
                                       key_padding_mask=src_key_padding_mask) # src_key_padding[16,240]
        # src2 [240,16,32] weights[16,240,240]
