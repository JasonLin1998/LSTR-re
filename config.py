...
class Config:
    def __init__(self):
        ...
        # Directories
        self._configs["data_dir"]   = "../dataset/tusimple"
        ...
        self._configs['rr_weight'] = 10
        self._configs["aux_rr"] = False
    ...
    @property
    def aux_rr(self):
        return self._configs["aux_rr"]

    @property
    def differ_rr(self):
        return self._configs["differ_rr"]
    ...
    @property
    def curve_predictor(self):
        return self._configs["curve_predictor"]
    ...
    @property
    def rr_weight(self):
        return self._configs["rr_weight"]
